...
video_img = pygame.image.load('img/video_btn.png').convert_alpha()
...
class ScreenFade():
    ...
    def fade(self):
        ...
        if self.direction == 1:  # whole screen fade
            ...
            pygame.draw.rect(
                screen, self.color, (0, 0 - self.fade_counter, SCREEN_WIDTH, SCREEN_HEIGHT // 2))
...
exit_button = button.Button(
    SCREEN_WIDTH // 2 - 110, SCREEN_HEIGHT // 2 + 150, exit_img, 1)
options_button = button.Button(
    SCREEN_WIDTH // 2 - 150, SCREEN_HEIGHT // 2 - 0, options_img, 1)
restart_button = button.Button(
    SCREEN_WIDTH // 2 - 100, SCREEN_HEIGHT // 2 - 50, restart_img, 2)
video_button = button.Button(
    SCREEN_WIDTH // 2 - 115, SCREEN_HEIGHT // 2 - 250, video_img, 1)
...
while run:
    ...
    if start_game == False:
        ...
        draw_text('Press Esc for menu', font, WHITE, (SCREEN_WIDTH - 200), 20)
